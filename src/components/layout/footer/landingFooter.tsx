        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-0">
              <span className="font-bold text-xl">Canny&apos;s</span>
            </div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  ...
                  className="flex items-center text-primary font-medium hover:text-primary/60"
                >
              ...
              <li>
                <Link
                  ...
                  className="flex items-center text-accent font-medium hover:text-accent/60"
                >
